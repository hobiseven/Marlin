...
#define HAS_I_MIN _HAS_STOP(I,MIN)
#define HAS_I_MAX _HAS_STOP(I,MAX)
#define HAS_J_MIN _HAS_STOP(J,MIN)
#define HAS_J_MAX _HAS_STOP(J,MAX)
#define HAS_K_MIN _HAS_STOP(K,MIN)
#define HAS_K_MAX _HAS_STOP(K,MAX)
