...
#define BOARD_RAMPS_14_NX             1025  // RAMPS 1.4 (Power outputs: Spindle, Controller Fan) for FILCHAUND_NX
...
#define BOARD_DERANDERE_PB_1          1510   // Repurposed Anet 1.0 (Melzi clone)
