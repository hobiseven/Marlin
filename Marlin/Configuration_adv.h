...
#define HOMING_BUMP_DIVISOR ARRAY_N(NON_E_AXES, 4, 4, 4, 4, 4, 4) // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#if NON_E_AXES == 6
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 50*60, 50*60, 50*60, 60 } // Feedrates for manual moves along X, Y, Z, E, I, J, K from panel
#elif NON_E_AXES == 5
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 50*60, 50*60, 60 } // Feedrates for manual moves along X, Y, Z, E, I, J from panel
#elif NON_E_AXES == 4
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 50*60, 60 } // Feedrates for manual moves along X, Y, Z, E, I from panel
#else // default for NUM_E_AXES == 3
